...
execute at @s[scores={cd=5..}] positioned ~ ~-0.5 ~ run tag @e[tag=r4r_ability_target,tag=!axe_throw_done,distance=..1.5] add axe_throw
...
execute as @e[tag=r4r_ability_target,tag=axe_throw,tag=!axe_throw_done] run function skills:axe/axe_throw_hit
