...
execute unless entity @s[tag=!invulnerable,nbt=!{ActiveEffects:[{Id:11}]},scores={helper_health=..300}] run execute at @s run function ragecraft4reforged:damage/damage3
