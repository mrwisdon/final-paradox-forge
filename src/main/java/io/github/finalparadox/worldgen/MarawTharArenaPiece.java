...
public final class MarawTharArenaPiece extends TemplateStructurePiece {
    public MarawTharArenaPiece(
            StructureTemplateManager templateManager,
            ResourceLocation template,
            BlockPos position
    ) {
        super(ModWorldgen.MARAWTHAR_ARENA_PIECE.get(), 0, templateManager,
    ...
    public MarawTharArenaPiece(
        ...
        super(ModWorldgen.MARAWTHAR_ARENA_PIECE.get(), tag, templateManager,
