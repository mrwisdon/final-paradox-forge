...
public final class B5ArenaPiece extends TemplateStructurePiece {
    public B5ArenaPiece(
            StructureTemplateManager templateManager,
            ResourceLocation template,
            BlockPos position
    ) {
        super(ModWorldgen.B5_ARENA_PIECE.get(), 0, templateManager,
    ...
    public B5ArenaPiece(
        ...
        super(ModWorldgen.B5_ARENA_PIECE.get(), tag, templateManager,
