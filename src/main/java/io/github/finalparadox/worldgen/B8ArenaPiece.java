...
public final class B8ArenaPiece extends TemplateStructurePiece {
    public B8ArenaPiece(
            StructureTemplateManager templateManager,
            ResourceLocation template,
            BlockPos position
    ) {
        super(ModWorldgen.B8_ARENA_PIECE.get(), 0, templateManager,
    ...
    public B8ArenaPiece(
        ...
        super(ModWorldgen.B8_ARENA_PIECE.get(), tag, templateManager,
